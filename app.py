...
cols[4].markdown(f'<div class="kpi-box" style="border: 2px solid {col_b};"><p class="kpi-label">{lab_b}</p><p class="kpi-value" style="color:{col_b};">€ {int(val_b):,}</p><p class="kpi-sub">vs obiettivo target</p></div>', unsafe_allow_html=True)
