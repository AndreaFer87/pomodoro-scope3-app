...
with st.sidebar.expander("📍 Piacenza", expanded=True):
    ...
    ado_pc_inter = st.slider("PC - Interramento (%)", 0.0, 100.0, value=25.0)
    ado_pc_comb  = st.slider("PC - Combinata (%)", 0.0, 100.0, value=25.0)

with st.sidebar.expander("📍 Cremona"):
    ado_cr_cover = st.slider("CR - Cover Crops (%)", 0.0, 100.0, value=25.0)
...
# --- DATABASE ---
DB_GEO = {
    'Piacenza': {'ettari': 4200, 'loss_soc': 1.8, 'ado': {'Cover Crops': ado_pc_cover/100, 'Interramento': ado_pc_inter/100, 'C.C. + Interramento': ado_pc_comb/100}, 'perf': {'Cover Crops': [-0.1, 1.8], 'Interramento': [0.3, 2.5], 'C.C. + Interramento': [0.3, 3.8]}},
    'Cremona': {'ettari': 2800, 'loss_soc': 0.05, 'ado': {'Cover Crops': ado_cr_cover/100, 'Interramento': ado_cr_inter/100, 'C.C. + Interramento': ado_cr_comb/100}, 'perf': {'Cover Crops': [0.1, 1.5], 'Interramento': [0.3, 2.2], 'C.C. + Interramento': [0.3, 3.5]}},
    'Mantova': {'ettari': 1300, 'loss_soc': 0.1, 'ado': {'Cover Crops': ado_mn_cover/100, 'Interramento': ado_mn_inter/100, 'C.C. + Interramento': ado_mn_comb/100}, 'perf': {'Cover Crops': [0.1, 1.5], 'Interramento': [0.3, 2.2], 'C.C. + Interramento': [0.3, 3.5]}},
    'Altre': {'ettari': 3700, 'loss_soc': 0.3, 'ado': {'Cover Crops': ado_al_cover/100, 'Interramento': ado_al_inter/100, 'C.C. + Interramento': ado_al_comb/100}, 'perf': {'Cover Crops': [-0.1, 1.4], 'Interramento': [0.3, 2.2], 'C.C. + Interramento': [0.3, 3.5]}}
}
