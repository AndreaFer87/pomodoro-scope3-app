...
c2.markdown(f'<div class="kpi-box"><p class="kpi-label">Impronta CO2 🍅</p><p class="kpi-value" style="color:#E64A19;">{impronta_iniziale:.2f} → {impronta_finale:.2f}</p><p class="kpi-sub">kg CO2/ton (Base vs Target)</p></div>', unsafe_allow_html=True)
